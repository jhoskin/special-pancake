...
type TodoServiceClient interface {
	...
	UpdateTodo(context.Context, *connect_go.Request[v1.UpdateTodoRequest]) (*connect_go.Response[v1.UpdateTodoResponse], error)
...
func NewTodoServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) TodoServiceClient {
	...
	return &todoServiceClient{
		...
		updateTodo: connect_go.NewClient[v1.UpdateTodoRequest, v1.UpdateTodoResponse](
			httpClient,
...
type todoServiceClient struct {
	...
	updateTodo *connect_go.Client[v1.UpdateTodoRequest, v1.UpdateTodoResponse]
...
func (c *todoServiceClient) UpdateTodo(ctx context.Context, req *connect_go.Request[v1.UpdateTodoRequest]) (*connect_go.Response[v1.UpdateTodoResponse], error) {
...
func NewTodoServiceHandler(svc TodoServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	todoServiceUpdateTodoHandler := connect_go.NewUnaryHandler(
...
func (UnimplementedTodoServiceHandler) UpdateTodo(context.Context, *connect_go.Request[v1.UpdateTodoRequest]) (*connect_go.Response[v1.UpdateTodoResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("todo.v1.TodoService.UpdateTodo is not implemented"))
}
...
func (UnimplementedTodoServiceHandler) DeleteTodo(context.Context, *connect_go.Request[v1.DeleteTodoRequest]) (*connect_go.Response[v1.DeleteTodoResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("todo.v1.TodoService.DeleteTodo is not implemented"))
}
